...
////// Emissive:
                ...
                return fixed4(finalColor,((node_6864*(node_803+node_5377+node_7037))*((lerp((node_1966_if_leA*node_8798)+(node_1966_if_leB*node_4202),node_4202,node_1966_if_leA*node_1966_if_leB)*lerp((node_4898_if_leA*node_8798)+(node_4898_if_leB*node_4202),node_4202,node_4898_if_leA*node_4898_if_leB))*(lerp((node_5022_if_leA*node_6065)+(node_5022_if_leB*node_5503),node_5503,node_5022_if_leA*node_5022_if_leB)*lerp((node_2807_if_leA*node_6065)+(node_2807_if_leB*node_5503),node_5503,node_2807_if_leA*node_2807_if_leB)))));
            }
            ENDCG
        }
    }
